...
import { Sprout, Tractor, Warehouse, ArrowRight, Leaf, Droplets, Activity, CalendarClock } from 'lucide-react';
        ...
        <div style={{ paddingBottom: '80px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '16px' }}>
                <StageCard
                    ...
                    icon={CalendarClock}
                    color="#2196F3" // Blue
                    description="View and manage your daily farming activities and schedules."
                    features={['Task Scheduling', 'Reminders', 'Event Tracking']}
                    onClick={() => navigate('/farm-management/calendar')}
                />
                <StageCard
