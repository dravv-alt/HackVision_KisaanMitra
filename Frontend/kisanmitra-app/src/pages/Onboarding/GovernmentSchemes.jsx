                    ...
                    {filterCategories.map((filter, index) => (
                        <button
                            ...
                            style={{
                                ...
                                padding: '10px 20px',
                                borderRadius: '24px',
                                backgroundColor: activeFilter === filter.label ? colors.textMain : 'white',
                                color: activeFilter === filter.label ? 'white' : colors.textSecondary,
                                border: activeFilter === filter.label ? 'none' : '1px solid #E6DCC8',
...
const SchemeCard = ({ title, desc, benefits, icon: Icon, iconColor, iconBg, tag, tagIcon: TagIcon, tagColor, footerLabel, footerAction, isClosed, borderHoverColor, link }) => {
    ...
    return (
        <div
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px' }}>
                ...
                {tag && TagIcon && (
                    <div style={{
                        ...
                        backgroundColor: tagStyles[tagColor]?.bg || '#F5F5F5',
                        color: tagStyles[tagColor]?.text || '#616161',
                        border: `1px solid ${tagStyles[tagColor]?.border || '#E0E0E0'}`,
            ...
            <div style={{ marginBottom: '16px', flex: 1 }}>
                ...
                {benefits && (
                    <div style={{ marginTop: '8px', fontSize: '0.9rem', fontWeight: 'bold', color: '#D9A54C' }}>
                        {benefits}
                    </div>
                )}
            </div>
